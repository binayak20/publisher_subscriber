  ...
  <div class="col-xs-2" style="border-right: 1px solid #dddddd">
    ...
    <div class="col-xs-7" >
      <?php 
       ...
       ?>
         <?php
            $Result = $_AddSubscriberBAO->getAllShowNotice($ID);
            if($Result->getIsSuccess()){
              $NoticeList = $Result->getResultObject();
              for($i = 0; $i < sizeof($NoticeList); $i++) {
                $Notice = $NoticeList[$i];
          ?>
     <div class="noticebox" style="border: 1px solid gray;box-shadow: inset 0 0 1em gray, 0 0 1em gray;">
     ...
     <a href="?favId=<?php echo $Notice->getID(); ?>"><button style="display: inline-block;float: right;margin-right:10px;" name="Add_Favourite" class="btn btn-success">Add Favourite</button></a>
     </div>
    ...
    <div class="col-xs-3">
       <div style="border: 1px solid gray;box-shadow: inset 0 0 1em gray, 0 0 1em gray;padding-left:10px;padding-top: 10px">
           ...
           <!--  <div id="sideboxx1" >YOUR SUBSCRIPTION</div> -->
               ...
               if($Result->getIsSuccess()){
                  ...
                  $Subcategory = $SubcategoryList[$i];
                    ?>
                <a href='view.notice.php?CatId=<?php echo $Subcategory->getCatID();?>'><?php echo $Subcategory->getName();?><span style="padding-left: 10px;color: red"><?php if($count > 0){echo $count; }?></span></a><br>
                  <?php 
