...
<!--                 <li class="active">
                  <a href="view.publisherApproval.php">
                    <span class="glyphicon glyphicon-user"></span> Request</a>
                </li> -->   
   ...
   <div class="col-sm-3" >
     ...
     <div class="col-sm-6">
        <?php 
          ...
          ?>
          <legend style="color: #286090;padding-left: 100px;padding-top: 10px">All Subscriber Request</legend>
          <?php 
            $Result = $_RequestBAO->getAllRequestOfSubscriber($ID);
            if($Result->getIsSuccess()){
            ...
            <?php
              ...
              for($i = 0; $i < sizeof($RequestList); $i++) {
                 $RequestSubscriber = $RequestList[$i];
          ?>
          ...
          <div class="row" style="background-color: #ddd;padding-top: 10px;margin-left: 5px;padding-bottom: 10px;margin-bottom: 5px">
                ...
                <div class="col-sm-2">     
                  <img src="<?php echo $_AddSubscriberBAO->getSubscriberImage($RequestSubscriber->getSubscriberID()); ?>" height="90px" width="80px"/>
                </div>
                <div class="col-sm-7" style="">
                   <p style="padding-left: 10px;">Group: <a href=""><?php echo $_AddSubscriberBAO->getGroupNameFromCatID($RequestSubscriber->getCatID()); ?></a></p>
                   <p style="padding-left: 10px;"> Name: <a href=""><?php echo $_AddSubscriberBAO->getNamefromSubscriberID($RequestSubscriber->getSubscriberID()); ?></a></p>
                   <p style="padding-left: 10px;">Institute: <a href=""><?php echo $_AddSubscriberBAO->getInstituteFromID($RequestSubscriber->getInstituteID()); ?></a></p>
                   
                </div>
                <div class="col-sm-3">
                  <a href="?accept=<?php echo $RequestSubscriber->getSubscriberID(); ?>&categoryId=<?php echo $RequestSubscriber->getCatID(); ?>&InstituteId=<?php echo $RequestSubscriber->getInstituteID(); ?>" onclick="return confirm('Are You Sure to Accept This Request !'); ">
                     <button type="button" class="btn btn-success" name="approve">Accept</button></a>
                  <a  href="?reject=<?php echo $RequestSubscriber->getSubscriberID(); ?>" onclick="return confirm('Are You Sure to Reject This Request !'); ">
    ...
    <div class="col-sm-3">
      <div style="background-color: #F5F6F7;height: 400px">
        <div class="col-sm-2">     
          <img src="recent.jpg" height="70px" width="70px"/>
        </div>
        <div class="col-sm-10" style="">
         <!--<button type="submit" class="btn btn-sm btn-success" name="request">+Join Subscriber</button><br>
         <button style="margin-top: 10px;padding-right: 16px" type="submit" class="btn btn-sm btn-success" name="request">+Join Publisher</button>-->
      </div>
      </div>
    </div>
  </div>
